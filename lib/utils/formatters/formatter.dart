...
class TFormatter {
  ...
  static String storageDateTime(DateTime? date) {
    date ??= DateTime.now();
    return DateFormat('yyyy-MM-dd HH:mm:ss').format(date); // Customize the date format as needed
  }

  static String displayingDate(DateTime? date) {
    date ??= DateTime.now();
